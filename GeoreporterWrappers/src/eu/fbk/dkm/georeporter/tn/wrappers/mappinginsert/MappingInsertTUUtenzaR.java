	...
	public static void associazioneMappingNomeVal(MappingTabella data, MappingTabella data2, MappingTabella data3,
		...
		for (int j = 0; j < listUtenzaRifiuti.size(); j++) {
			...
			if (listUtenzaRifiuti.get(j).getValori().get("codfiscale").isEmpty() == false) {
				...
				String codfis = listUtenzaRifiuti.get(j).getValori().get("codicefiscale");
			...
			if (listUtenzaRifiuti.get(j).getValori().get("particellaedificabile").isEmpty()) {
				num = "";
				den = "";
				sub = "";
			}
			...
			// relazione TributiUtenza UtenzaRifiuti con CONTRIBUENTE
			if (listUtenzaRifiuti.get(j).getValori().get("codfiscale").isEmpty() == false) {
			...
			// relazione TributiUtenza UtenzaRifiuti con Identificativo Catastale
			if (listUtenzaRifiuti.get(j).getValori().get("particellaedificabile").isEmpty() == false) {
				Relazione rel = new Relazione();

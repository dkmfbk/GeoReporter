...
public class MappingInsertTUUtenzaR {
	...
	public  void associazioneMappingNomeVal(MappingTabella data, MappingTabella data2, MappingTabella data3,
		...
		for (int j = 0; j < listUtenzaRifiuti.size(); j++) {
			...
			// ciclo per crea e listaATTRIBUTI richiesti dal mapping Utenza Rifiuti
			...
			for (int i = 0; i < data8.getAttributi().size(); i++) {
				...
				if ((listUtenzaRifiuti.get(j).getValori().get(parts8[1]) != null)
						&& (listUtenzaRifiuti.get(j).getValori().get(parts8[1]).isEmpty() == false)) {
					tmp8.setValore(listUtenzaRifiuti.get(j).getValori().get(parts8[1]));
			...
			for (int i = 0; i < data9.getAttributi().size(); i++) {
				...
				if ((listUtenzaRifiuti.get(j).getValori().get(parts9[1]) != null)
						&& (listUtenzaRifiuti.get(j).getValori().get(parts9[1]).isEmpty() == false)) {
					tmp9.setValore(listUtenzaRifiuti.get(j).getValori().get(parts9[1]));
			...
			List<Relazione> listRelUR = new ArrayList<Relazione>();
			// ID UNIVOCO ??
			...
			if (listUtenzaRifiuti.get(j).getValori().get("indirizzocontribuente").isEmpty() == false) {
			...
			if (listUtenzaRifiuti.get(j).getValori().get("indirizzorecapitocontribuente").isEmpty() == false) {
			...
			if (listUtenzaRifiuti.get(j).getValori().get("indirizzo").isEmpty() == false) {
